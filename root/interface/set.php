...
?>                            
    ...
    <div class="ui purple segment">
        <h4 class="ui header">
            <i class="globe icon"></i> Ujian Setting
        </h4>
        <div class="ui divider"></div>
        <div class="fields" style="margin-top: 10px;">
            <div class="six  wide field">
                <label for="limit_ub">Masukkan Jumlah UB untuk Poin UN</label>
                <div class="ui input search focus">
                    <input class="prompt" id="limit_ub" name="limit_ub" placeholder="Limit UB" type="text" autocomplete="off" value="<?php echo $limit_ub?>">
                </div>
            </div>
        </div>    
        <span>Limit jumlah UB untuk tahun berjalan saat ini = <?php echo $limit_ub?></span><br>   
        <div class="ui orange button" onclick="editLimit()">
            <i class="edit icon"></i> Edit
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function editLimit(){
        ...
        $.post('interface/set-limitub.php',{value: value},
            function(result){
                console.log(result);
                loadingSelesai();
                location.reload();
