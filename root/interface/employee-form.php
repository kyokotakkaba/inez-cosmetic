...
<form id="frmEmployee">
    ...
    <div class="field">
        <label>Wlayah</label>
        <div class="ui search" onkeyup="cariAjax('wilayah','id_wil', '../')">
            <input class="prompt" id="nama_wil" name="nama_wil" placeholder="Wilayah" type="text" value="<?php echo $nama_wil; ?>" >
            <input id="id_wil" name="id_wil" type="hidden" value="<?php echo $id_wil; ?>">
            <div class="results"></div>
        </div>
        <p style="font-size: 9pt; color: #60646D; margin-top: 10px;">
            *Cari wilayah, pilih dari opsi yang tersedia.
        </p>
    </div>
...
?>                
    ...
    <div class="ui floating message">
        <p>Hak Akses: <strong><?php echo $jenis; ?></strong></p>
<?php
    if($id == '0'){
?>
        <p style="font-size: 9pt; color: #60646D; margin-top: 10px;">
            Admin dapat diset melalui setting wilayah dan memilih supervisi
        </p>
<?php        
    }
?>
...
<script type="text/javascript">
    ...
    $('#frmEmployee').submit(function(e){
        ...
        if(id_wil==''){
            tampilkanPesan('0','Tentukan Willayah.');
            loadingSelesai();
        }
        else if(jenis==''){
