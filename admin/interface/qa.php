...
<div id="dataDisplay">
    <div class="ui basic vertical segment clearing" style="margin: 0px; padding: 0px;">
        <div class="ui icon button right floated" onclick="updateRowQa()" data-content="Reload">
            <i class="redo icon"></i>
        </div>
        <div class="ui green icon button right floated" onclick="loadForm('qa','0')">
            <i class="plus icon"></i> Tanya
        </div>

        <select id="id_kelompok" name="id_kelompok" class="ui compact dropdown" onchange="updateRowQa()">
<?php
    $q = "
            SELECT 
                id, 
...
?>
        ...
        <select id="status" name="status" class="ui compact dropdown" onchange="updateRowQa()">
            <option value="semua">Semua</option>
    ...
    <div class="ui vertical basic segment clearing" style="padding: 0px;">
        <select class="ui dropdown compact" id="jumlahRow"  onchange="updateRowQa()">
